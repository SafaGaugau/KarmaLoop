...
public class PlayerSettings : MonoBehaviour 
{
    ...
    [SerializeField] private float BASEplayerHeath = 10f;
    ...
    public float Health => BASEplayerHealth;

    public float TakeDamage(float damage) { return BASEplayerHealth - damage; }
}
